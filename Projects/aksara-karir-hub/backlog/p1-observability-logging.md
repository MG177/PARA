...
- **Cron health**: Sentry cron monitors or dead-man-switch on each scheduled job — see [[Projects/aksara-karir-hub/backlog/p0-cron-reminders-fix]].
...
- Related: [[Projects/aksara-karir-hub/backlog/p0-cron-reminders-fix]]

## Links

- [[Projects/aksara-karir-hub/context/system-overview]]
