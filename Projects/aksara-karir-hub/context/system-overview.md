...
High-signal pointer doc. Canonical architecture and data-model docs live in the in-repo submodule under [[Projects/aksara-karir/README]]. This file captures only the operational realities and gaps the in-repo docs currently omit.
...
`CRON_SECRET` env exists; the **schedule entries themselves are missing** from `vercel.json` / project config. See backlog [[Projects/aksara-karir-hub/backlog/p0-cron-reminders-fix]].
...
- Technical docs submodule (clone root): `Projects/aksara-karir/` ↔ https://github.com/MG177/aksara-karir-lms-docs — vault hub lives in `Projects/aksara-karir-hub/`.
